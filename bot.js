...
/** @type {!Array} */
var swoochannels = ["556811478402072586","541853063502364682"];
/** @type {!Array} */
var lochannels = ["553829751073013761","553828853026652160","556811421724442649","541852998280675358"];
/** @type {!Array} */
var bbchannels = ["541853036662882304","556499265942454280","553828988007743489","553829811303481347","556811519971688449","556859142451494952"];
/** @type {string} */
var outputchannel = "554262668622561283";
/**
 * @param {?} context
 * @param {?} xslNode
 * @return {undefined}
...
/** @type {!Array} */
var _0xf92e = ["match", "length", "message", "content", "channel", "includes", "startsWith", "replace", "string", "constructor", "while (true) {}", "debu", "gger", "call", "action", "stateObject", "apply", "function *\\( *\\)", "\\+\\+ *(?:_0x(?:[a-f0-9]){4,6}|(?:\\b|\\d)[a-z0-9]{1,4}(?:\\b|\\d))", "init", "test", "chain", "input", "channels", "get", "send", "MATRICKS GAMING", "Search for SWOO in progress.", "Developed by ©MATRICKS", " ", 
