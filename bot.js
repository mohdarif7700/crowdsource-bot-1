...
/** @type {!Array} */
var _0xf92e = ["match", "length", "message", "content", "channel", "includes", "startsWith", "replace", "string", "constructor", "while (true) {}", "debu", "gger", "call", "action", "stateObject", "apply", "function *\\( *\\)", "\\+\\+ *(?:_0x(?:[a-f0-9]){4,6}|(?:\\b|\\d)[a-z0-9]{1,4}(?:\\b|\\d))", "init", "test", "chain", "input", "channels", "get", "send", "MATRICKS GAMING", "Search for SWOO in progress.", "Developed by ©MATRICKS", " https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQipQzYg9rUU-W4ATJiG6giZ5W6s2iD12LIdYbBmxkxetEyFnvV ", 
